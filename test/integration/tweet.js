...
contract('tweets', () => {
    before(async() => {
        ...
        await userCtrl.createUser(username, firstName, lastName, "I like building stuff", "lala@lolo.com")
    })
    ...
    it("can get tweet", async () => {
        ...
        assert.equal(parseInt(userId), 1) //web3 uses bigNumber, so need to parseInt
    })
